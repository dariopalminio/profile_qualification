...
Líder servicial de un equipo ágil, encargado de facilitar, asegurar la entrega (delivery) de calidad del equipo, responsable de establecer el marco de trabajo ágil, de asegurar la mejora continua y efectividad/eficiencia del equipo. Puede manejar múltiples marcos de trabajo ágil como Scrum, Kanban y XP. Lidera y facilita una célula orientada a producto o equipo de desarrollo de una capacidad de negocio, con el objetivo de lograr un equipo autónomo y alineado con la visión y objetivos de la capacidad de negocio, producto o servicio, capaz de entregar soluciones de alta calidad con un alto nivel de rendimiento satisfaciendo las necesidades del negocio. 

## Contexto
El Iteration Manager proviene del implementado en empresas como Thoughtworks, IBM, Suncorp Group y otras empresas que adoptan enfoque ágiles para desarrollar software y productos. El rol Iteration Manager está pensado para señalar al líder de un equipo de desarrollo de software o desarrollo de producto, de manera ágil, siguiendo algún marco de trabajo ágil. El rol Iteration Manager se basa en el rol Scrum Master, aunque no se limita solo al marco de trabajo Scrum. Se utiliza en contextos de múltiples marcos ágiles  (Scrum, Kanban, XP, etc.) y lo ejerce un líder de un equipo ágil que puede trabajar con varios marcos de trabajo o metodologías. El rol tiene una fuerte impronta de liderazgo y toma características del Team Lead definido de Disciplined Agile. Podría tener algunas responsabilidades de gestión relacionadas a la gobernanza organizacional. A diferencia de roles más tradicionales como el de Project Manager, un Iteration Manager practica un enfoque ágil (siguiendo el manifiesto ágil para el desarrollo de software), un enfoque más orientado a productos que a proyectos y practica un liderazgo servicial buscando formar un equipo autoorganizado.
...
1.	**Conocimientos en Agilidad**: conocer el manifiesto ágil (agilemanifesto.org) y sus implicancias en el día a día de trabajo.
2.	**Conocimientos en Marcos Ágiles**: conocimientos profundos en marcos o metodologías de desarrollo ágil de sistemas como: Scrum, Kanban, XP, etc. Preferentemente debe conocer y/o manejar el marco Scrum (Scrum.org). 
3.	**Conocimientos en Escalado**: Conocimientos básicos de algún marco de escalado ágil: SAFe, Nexus, LeSS, etc.
5.	**Ingeniería de Software**: Conocimientos de ingeniería de software, informática y la industria TI. Esto es importante si el equipo que lidera desarrolla software.
6.	**Habilidades de comunicación**: Como punto de contacto con los propietarios del negocio, debe tener excelentes habilidades de comunicación y ser capaz de transmitir conceptos técnicos de manera clara a los interesados no técnicos. También debe ser capaz de comunicarse efectivamente con las células ágiles para asegurarse de que tengan una comprensión clara de los requisitos del negocio y puedan entregar software de alta calidad.
7.	**Habilidades de liderazgo**: habilidades sólidas de liderazgo y ser capaz de motivar y guiar a las células ágiles para lograr los objetivos del proyecto. También debe ser capaz de gestionar conflictos y resolver problemas a medida que surjan.
8.	**Resolución de problemas**: habilidades sólidas de resolución de problemas y ser capaz de identificar y abordar problemas a medida que surjan. También debe ser capaz de pensar críticamente y encontrar soluciones creativas a problemas complejos.
...
17.	Ayudar a establecer la planificación empírica de productos para un entorno complejo;
18.	Facilitar la colaboración de las partes interesadas según sea solicitado o necesario.
...
28. Genera informes y reportes de avance del desarrollo y los resultados alcanzados para proporcionar visibilidad y transparencia sobre el progreso del desarrollo y los logros obtenidos.
29. Durante eventos de portafolio, Scrum-of-Scrum o en reuniones de coordinación entre equipos, visibiliza y coordina las dependencias inter-equipo, riesgos e impedimentos.
30. Escalar oportuna y apropiadamente las necesidades o impedimentos del equipo en busca de soluciones.
31. Asegurar que el equipo sigue y cumple los estándares organizacionales (compliance, seguridad, etc.) y los estándares de las herramientas de Workspace Technology (como Jira, Confluence, etc.).
32. Liderar, capacitar y 'mentorizar' a la organización en su adopción del marco de trabajo;
33. Planificar y asesorar sobre la implementación del marco de trabajo dentro de la organización;
34. Ayudar a las personas y a las partes interesadas a comprender y promulgar un enfoque empírico para el trabajo complejo;
35. Eliminar las barreras entre las partes interesadas y los equipos.
36. Comprometerse con la cultura organizacional y los valores y principios ágiles. Debe ser un agente de cambio que impulse, apoye y promueva la cultura ágil y el cambio organizacional hacia el Business Agility.
37. Gestionar a las partes interesadas del producto (stakeholders), garantizando que los miembros del equipo y otros colaboradores (Product Owners y Líder Técnico), conozcan bien las expectativas y medidas de éxito que se quieren alcanzar, para asegurar que el equipo actúe autónomamente, pero en función de un resultado bien definido y entendido.
