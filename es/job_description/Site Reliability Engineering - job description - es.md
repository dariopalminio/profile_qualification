...
Certificaciones como: ITIL 4 certification, Site Reliability Engineering (SRE) Foundation Certified (DevOps Institute), Site Reliability Engineering (SRE) Practitioner Certified (Devops Institute), Site Reliability Engineering Certified Professional (SRECP), Site Reliability Engineering on AWS, Certified SRE Practitioner (GSDC); Certificación en metodología Kanban como: Professional Kanban I, Team Kanban Practitioner, etc.
