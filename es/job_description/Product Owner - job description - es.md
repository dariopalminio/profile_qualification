...
### Responsabilidades como Decisor
...
## Técnicas empleadas
Un Product Owner conoce y/o maneja algún conjunto de técnicas para cada dimensión del rol.

### Técnicas para Visionario
...
- Descubrimiento Continuo: Design Thinking, Product Discovery, Dual Tracking, Need Finding, Feature Discovery, Design Sprint, Agile Inception (Lean Inception/Inception Desk), Opportunity Mapping (Opportunity Solution Tree), Grupos Focales (Focus Groups), prototipos (Prototyping).
...
- Definir Estrategia en un Árbol de Valor: LVT (Goal, Bet, MoS), One Metric that Matters (OMTM), North Start Metric, OKR, Balanced Scorecard, Matriz BCG, 3 Horizons Model, FODA, Porter, Blue Ocean, Matriz de Ansoff, Triángulo DELTA, Hypothesis Statement, Opportunity Solution Tree, Análisis de decisión, Análisis FODA.
...
- Especificar Características: Brainstorming, Feature by Example (BDD), Feature Mapping, Escenarios y Casos de Uso (Use Cases) (CASE Tool), User Flow (UI Storyboards), Screen sketches, BDD, Impact Mapping, Concrete UI prototype, Criterios de Aceptación, Diccionario de datos y glosario, Análisis de Documentos, Descomposición funcional, Análisis de Interfaz, Análisis de Requerimientos No Funcionales (Non-functional Requirements), Talleres de Requisitos (Workshop).
...
### Técnicas para Voz del Cliente
- Crear y Optimizar Propuesta de Valor: Value Proposition Canvas.
- Describir al Usuario: Segmentación de Clientes, Empathy Map, Arquetipos de Persona, Entrevistas, Técnicas de Observación, Encuesta/Cuestionario.
- Mejorar Experiencia del Cliente: Customer Journey,  Jobs to be Done (JTBD), Problem Statement, Hypothesis Statement.
- Escribir Historias de Usuario: User Story, Acceptance Criteria, Modelo 3Cs, BDD Acceptance Criteria, INVEST, Criterios de Aceptación, Análisis de Reglas de Negocio
...
### Técnicas para Colaborador
- Dedicar tiempo al equipo (100%): Scrum Guide.
- Colaborar con Marco de Trabajo: Planning, Daily (si es requerido), Refinamiento, Review, Retrospective.
- Gestionar Tipos de Trabajo: EDGE (Estratégico, BAU, Mejora Técnica), CAPEX/OPEX, Clases de Servicio (Kanban).
- Gestionar Riesgos y Dependencias: Mapa de dependencias, ROAM matrix, Risk Heat Map, Seguimiento de problemas (Problem Tracking), Análisis de riesgo.
...
- Definir, Medir y Evaluar Resultados con MoS: MoS, Value Metrics EBMgt, Métricas e indicadores clave de desempeño (KPI), Value Tree, Buyers Journey, Sales Funnel, AARRR Pirate Metrics Framework, KPI Mapp, One Metric that Matters (OMTM), North Start Metric.
- Inspeccionar y Adaptar Progreso: Roadmapping, Scrum, Kanban.
- Analizar y Mejorar Procesos para Excelencia Operacional: Service Design, Lean Thinking, Lean Manufacturing, Theory of Constraints (TOC), Value Stream Mapping (VSM), BPMN, Proceso de Lecciones Aprendidas.
### Técnicas para Influenciador
...
- Workspace tool: Google Workspace (Gmail, Calendar, Meet, Chat, Drive, Docs, Sheets, Slides, Forms, etc.), suite Microsoft 365.
